...
<div class="pacbox" >
    <h1 >Advanced Visualization Package</h1>
        <ul>
          <li>Advanced Visualization Package provides methods to express analysis
            results in more various ways.<br/>
            You can draw 3D network maps with one more variable by using
            5 kinds of 3D visalization algorithms.<br/>
             And 9 kinds of charts specialized in network data, including
          Network Contour and Surface plot, are also offered.</li>
