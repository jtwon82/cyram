...
<head>
	...
	function create() {
		if(checkVal()) {
			doAjax("boardModel", "/manager/appstore/appstore-create.do", "<c:out value = '${msg_save}'/>.", "list_init()");
		}
	}

	function update() {
		if(checkVal()) {
			doAjax("boardModel", "/manager/appstore/appstore-update.do", "<c:out value = '${msg_save}'/>", "list()");
		}
	}
	
	function del() {
		doAjax("boardModel", "/manager/appstore/appstore-delete.do", "<c:out value = '${msg_delete}'/>", "list_init()");
	}
	...
	function list() {
		...
		frm.action = "/manager/appstore/appstore-readList.do";
		frm.submit();
	}
	...
	function delete_comment(wr_comment) {
		...
		if(confirm('정말 삭제하시겠습니까?')) {
			...
			doAjax("boardModel", "/manager/appstore/appstore_comment-delete.do", "<c:out value = '${msg_delete}'/>", "fn_reload()");
		}
	}
    ...
    <div class="viewsearch mdl10" > 
     ...
     <ul>
       ...
       <li>
        ...
        <tr>
             <td class="viewline"  style="width:100px;"><strong>Version</strong></td>
             <td class="viewline"><form:input path="wr_link2" class="input_w300" /></td>
            </tr> 
