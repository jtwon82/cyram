...
<%
  ...
  String CST_MID = request.getAttribute("mid").toString();
    ...
    result.append("프로그램 <a style='color:blue;text-decoration:underline;' href='mailto:netminer@cyram.com'>netminer@cyram.com</a>, 031-739-8352<br/>");
    result.append("교육 및 컨설팅 서비스 <a style='color:blue;text-decoration:underline;' href='mailto:edu@netminer.com'>edu@netminer.com</a>, 070-8285-6078<br/><br/>");
	...
	if (xpay.TX()) {
        ...
        result.append("결제가 확인 되는 대로 프로그램 및 기타 서비스가 제공될 예정이며,<br/>");
        result.append("영업일 기준 1~2일 정도 소요됩니다.<br/><br/>");
        result.append("감사합니다.<br/><br/>");
        result.append("<ul><li style='list-style-type:disc;text-align:center;margin-left:14px;'>NetMiner<a style='float:right;color:blue;text-decoration:underline;' href='mailto:netminer@cyram.com'>netminer@cyram.com</a></li>");
        result.append("<li style='list-style-type:disc;text-align:center;'>교육 및 컨설팅<a style='float:right;color:blue;text-decoration:underline;' href='mailto:edu@cyram.com'>edu@cyram.com</a></li></ul>");
		if ("0000".equals(xpay.m_szResCode)) {
%>
<script type="text/javascript">
	var frm = document.getElementById('settlementModel');
	frm.action = "/autosettlement/settlementpaidcomplete-update.do";
	frm.target = "settlement_iframe";
	frm.submit();
...
<body>
	...
	<iframe name="settlement_iframe" id="settlement_iframe" width="0"
		height="0" frameborder="0" scrolling="no" marginheight="0"
