...
<head>
	...
	function create_comment() {
		if(checkVal()) {
			doAjax("boardModel", "/community/event/event_comment-create.do", "<c:out value = '${msg_save}'/>.", "fn_reload()");
		}
	}
	...
	function delete_comment(wr_comment) {
		...
		doAjax("boardModel", "/community/event/event_comment-delete.do", "<c:out value = '${msg_delete}'/>", "fn_reload()");
	}
