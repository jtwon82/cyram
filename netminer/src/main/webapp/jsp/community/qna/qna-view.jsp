...
<head>
	...
	function create_comment() {
		if(checkVal()) {
			doAjax("boardModel", "/community/qna/qna_comment-create.do", "<c:out value = '${msg_save}'/>.", "fn_reload()");
		}
	}
	...
	function delete_comment(wr_comment) {
		...
		doAjax("boardModel", "/community/qna/qna_comment-delete.do", "<c:out value = '${msg_delete}'/>", "fn_reload()");
	}
	...
	function del() {
		if(confirm("<c:out value = '${msg_delete_confirm}'/>")) {
			doAjax("boardModel", "/community/qna/qna-delete.do", "<c:out value = '${msg_delete}'/>", "list_init()");
		}
	}
	</script>
...
<body>
  ...
  <div id="container02" >
    ...
    <div class="submain" >
             <img src="/images/sub/contitle05.gif" alt="appstore" />
