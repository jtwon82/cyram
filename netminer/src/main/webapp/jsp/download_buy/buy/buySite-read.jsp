...
To meet Brand New NetMiner, complete the form below first and click ‘Request’ button please. NetMiner Team will send you an estimate as soon as possible.</li>
  ...
  <tr>
    <td  class="brline2">License <span style="color:red;">*</span></td>
    <td>
...
<!-- 			<option value="Enterprise">Enterprise</option> -->
  ...
  <tr>
    <td  class="brline2">Data Size <span style="color:red;">*</span></td>
    <td>
  ...
  <tr>
    ...
    <td>
    	<input id="sns" name="sns" type="checkbox"/>SNS Data Collector: SNS data collection from Facebook, Twitter and Youtube<br/>
    	<input id="bibl" name="bibl" type="checkbox"/>Biblio Data Collector: Bibliographic data collection from online<br/>
