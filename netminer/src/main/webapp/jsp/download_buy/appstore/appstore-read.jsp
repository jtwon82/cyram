...
<head>
	...
	function create() {
		if(checkVal()) {
			doAjax("boardModel", "/download_buy/appstore/appstore-create.do", "<c:out value = '${msg_save}'/>", "list_init()");
		}
	}
	
	function update() {
		if(checkVal()) {
			doAjax("boardModel", "/download_buy/appstore/appstore-update.do", "<c:out value = '${msg_save}'/>", "view()");
		}
	}
