...
<body>
  ...
  <div id="container02" >
    ...
    <ul>
     <li class="mdt15">
      (1) 사용자<br/>
     본 “사용자”는 학위를 수여하는 교육기관(이하 “교육기관”)으로서 이 “소프트웨어”를 사용하고자 하는 “교육기관” 및 교육을 담당하는
     소속 인을 대상으로 합니다. “교육기관” 소속의 행정 부서와 연구 및 개발 부서, 그리고 기타 비영리 단체 등은 본 “사용자”에 해당 되지 
     않습니다.

      </li>
      <li class="mdt15">
        (2) 제품의 설치<br/>
      본 사용권에 의한 제품 설치는 "사용자" 소유 또는 "사용자"가 임대한 개인용 컴퓨터에 한하여 가능하며 이 외에 허용된 실사용자 
     수를 초과한 설치나 네트워크 서버와 같은 공용 저장장치에 대한 저장 및 설치가 금지되어 있습니다. 


      </li>
      <li class="mdt15">
     (3) 실사용자<br/>
      본 사용권의 실사용자는 "교육기관"에 학위과정으로 등록된 학생(이하 "학생") 및 "교육기관" 소속인(이하 "소속인")으로 제한됩니다. 
     여기서 "소속인"은 "교육기관" 소속의 교수 및 강의 전담 직원으로 한정하며 이 외 "사용자"와의 계약상 근로자 및 자문위원 등은 
     "소속인"의 범위에서 포함되지 않습니다.
      ...
      <li class="mdt15">
         (4) 사용의 용도<br/>
    "사용자"에 의한 이 "소프트웨어"의 설치와 사용은 1)"사용자" 본인 또는 "사용자"에 의해 권한이 허용된 "소속인"이 "교육기관" 내에서
     수행하는 일상적인 강의 또는 비영리 목적 및 학술 연구 목적과 2)"사용자"에 의해 권한이 허용된 "학생"이 "사용자"가 진행하는 
     업무의 요구사항을 충족하기 위한 목적에 한하여 가능합니다.
