...
Huge (~1,000,000)</td>
    ...
    <ul>
     <li class="mdt15">
      (1) 사용자<br/>
    본 “사용자”는 영리기업 소속 연구기관 외의 연구 목적의 기관이거나 비영리 단체로서 이 “소프트웨어”를 사용하고자 하는 기관 및 
     기관 소속 인을 대상으로 합니다.
     ...
     사용 가능합니다.
      ...
      <li class="mdt15">
     (3) 실사용자<br/>
     본 사용권의 실사용자는 "사용자" 본인 또는 "사용자"에 의해 권한이 허용된 실제 운영자로 제한됩니다.
      </li>
      <li class="mdt15">
         (4) 사용의 용도<br/>
    특별한 제한이 없습니다.
    ...
    ㈜사이람의 라이선스 계약은 사용자 본인 혹은 소속기관의 내부용도에 한정합니다. 이 소프트웨어를 이용하여 대외의 제3자를 
     상대로 한 직접 및 간접적인 서비스나 수익 창출 시에는(교육 또는 컨설팅 등) ㈜사이람과 로열티 계약을 별도로 체결해야 하며 
     이 소프트웨어를 이용한 계약 외의 사용자 수익에 대해 ㈜사이람은 기본적으로 청구권을 행사할 수 있습니다.
