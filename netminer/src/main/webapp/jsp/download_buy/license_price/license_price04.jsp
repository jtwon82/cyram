...
<body>
  ...
  <div id="container02" >
    <div class="submain" > <img src="/images/sub/contitle21.gif" alt="demo" width="200" height="30"/>
      ...
      <div class="viewtab02 mdt20" id="about">
        <ul>
          ...
          <li  class="mdl1"><a href="/download_buy/license_price/license_price04.do">Academic</a></li>
      ...
      <div class="buybox" >
				...
				<h1 class="mdt15">Academic Use </h1>
    <ul>
     <li class="mdt15">
      (1) License<br/>
     The LICENSEE must be a degree-granting educational institution or its enrolled faculty and academic staffs. Research and 
     development divisions, administration center within educational institution and other not-for-profit organizations do not qualify for 
     the Academic license.

      </li>
      <li class="mdt15">
        (2) Installation<br/>
      Software may only be installed and operated on one (1) individual, stand-alone computer that the LICENSEE owns or leases,
     provided (i) the Software are only accessible to, and operated by LICENSEE, and (ii) the LICENSEE has provided machine-
     specific identification for that computer through the registration and activation process. Network installation is prohibited.
      ...
      <li class="mdt15">
     (3) User<br/>
      Any enrolled student, or employee (faculty and academic staffs) who is granted as an individual or authorized by the licensee to 
    use the Software.
    As used herein, "employees" exclude subcontractors and consultants of the LICENSEE. 
    ...
    (i) in the case of employees (faculty and academic staff), teaching, and non-commercial, academic research in their ordinary 
    course as LICENSEE's employees; 
