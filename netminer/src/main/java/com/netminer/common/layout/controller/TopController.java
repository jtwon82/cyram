...
@Controller
public class TopController extends CyframeController {

	@Inject
	private TopServiceIf topService;

	@RequestMapping("/common/layout/top-read.do")
	public String read(TopModel topModel, Model model) throws Exception {
		model.addAttribute("topModel", topModel);
		return "/common/layout/top-read";
	}

	@RequestMapping("/common/layout/top-update.do")
